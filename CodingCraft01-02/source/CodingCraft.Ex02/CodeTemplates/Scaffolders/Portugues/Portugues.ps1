...
$modelTypePluralized = $foundModelType.Name + "s"
...
if (!$NoChildItems) {
    ...
    if ($ViewScaffolder) {
        @("Criar", "_Criar", "_CriarZurb", "_CriarInk", "Editar", "_Editar", "_EditarZurb", "_EditarInk", "Excluir", "_Excluir", "_ExcluirZurb", "_ExcluirInk", "Detalhes", "_Detalhes", "_DetalhesZurb", "_DetalhesInk", "Index", "_Index", "_IndexZurb", "_IndexInk", "_CriarOuEditar", "_CriarOuEditarZurb", "_CriarOuEditarInk") | %{
