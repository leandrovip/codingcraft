...
using VipControle.MVC.Core.ViewModels;
...
namespace VipControle.MVC.Core.Controllers
{
    ...
    public class ManageController : Controller
    {
            ...
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess
                    ...
                    : message == ManageMessageId.SetPasswordSuccess
                        ? "Sua senha foi configurada."
                        : message == ManageMessageId.SetTwoFactorSuccess
                            ? "Seu provedor de two-factor foi configurado."
                            : message == ManageMessageId.Error
                                ? "Ocorreu algum erro."
                                : message == ManageMessageId.AddPhoneSuccess
                                    ? "Seu número de telefone foi adicionado."
        ...
        {
            ViewBag.UsuarioId = new SelectList(db.Users.Where(x => x.EmailConfirmed == false).ToList(), "Id", "Email");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ConfirmarEmail(string usuarioId)
        {
            if (usuarioId == null)
            {
                ViewBag.UsuarioId = new SelectList(db.Users.Where(x => x.EmailConfirmed == false).ToList(), "Id", "Email");
            ...
            var tokenEmail = await UserManager.GenerateEmailConfirmationTokenAsync(usuarioId);

            await UserManager.ConfirmEmailAsync(usuarioId, tokenEmail);
